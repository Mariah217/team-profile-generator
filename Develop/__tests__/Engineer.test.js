...
describe ("Engineer", ()=>{
    ...
    describe("Engineer", ()=>{
        it("Test engineer's methods", ()=>{
            const engineer = new Employee ('Samantha', 3, 'samantha123@gmail.com', 'samantha30')
            ...
            expect(engineer.getGithub()).toEqual('samantha30') //this is not working, not showing up as a method?????
    })
})